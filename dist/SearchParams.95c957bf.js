...
const Results = ({
  ...
  return (0, _core.jsx)("div", {
    className: "search"
  }, !pets.length ? (0, _core.jsx)("h1", null, "No Pets Found") : pets.map(pet => {
    return (0, _core.jsx)(_Pet.default, {
      animal: pet.type,
      key: pet.id,
      name: pet.name,
...
// this is a custom hook called useDropdown
...
const SearchParams = () => {
  ...
  async function requestPets() {
    ...
    setPets(animals || []);
  } // this effect only runs if 'animal', 'setBreeds', or 'setBreed' changes. So if the location changes, the effect has no need to run again
  ...
  }, (0, _core.jsx)("h1", null, location), (0, _core.jsx)("form", {
    onSubmit: e => {
      e.preventDefault();
      requestPets();
    }
